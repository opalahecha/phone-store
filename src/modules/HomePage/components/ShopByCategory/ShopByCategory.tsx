...
import phonesImg from '../../../../assets/images/phones.webp';
import tabletsImg from '../../../../assets/images/tablets.webp';
      ...
      <div className={styles.shopByCategory__grid}>
        {CATEGORIES.map(c => (
          <Link
            ...
            to={`/${c.id}`}
            className={cn(
              styles.shopByCategory__card,
              styles[`shopByCategory__card--${c.id}`],
            )}
          >
